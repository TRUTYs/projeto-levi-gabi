"""
Eight Sistemas — Ponto de entrada da aplicação.
"""
...
def create_app(config_class=Config):
    # Valida configuração antes de iniciar (bloqueia produção sem SECRET_KEY)
    ...
    # Injeta session nos templates automaticamente
...
if __name__ == "__main__":
    # Desenvolvimento local — debug ativo, acessível só na máquina
